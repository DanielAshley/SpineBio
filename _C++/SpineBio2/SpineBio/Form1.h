...
namespace SpineBio {
	...
	private: System::Windows::Forms::TextBox^  textBoxAnalogValue;
	private: System::Windows::Forms::Button^  buttonConnectLC;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBoxLoadCell = (gcnew System::Windows::Forms::GroupBox());
			this->buttonConnectLC = (gcnew System::Windows::Forms::Button());
			this->textBoxAnalogValue = (gcnew System::Windows::Forms::TextBox());
			...
			this->textBoxNumOfSteps->Text = L"8";
			// 
			// textBoxDwellTime
			// 
			...
			this->textBoxDwellTime->Text = L"2";
			// 
			...
			// groupBoxLoadCell
			// 
			this->groupBoxLoadCell->Controls->Add(this->textBoxAnalogValue);
			this->groupBoxLoadCell->Controls->Add(this->buttonConnectLC);
			this->groupBoxLoadCell->Location = System::Drawing::Point(342, 33);
			this->groupBoxLoadCell->Name = L"groupBoxLoadCell";
			this->groupBoxLoadCell->Size = System::Drawing::Size(223, 144);
			this->groupBoxLoadCell->TabIndex = 22;
			this->groupBoxLoadCell->TabStop = false;
			this->groupBoxLoadCell->Text = L"Load Cell Connection";
			// 
			// buttonConnectLC
			// 
			this->buttonConnectLC->Location = System::Drawing::Point(6, 18);
			this->buttonConnectLC->Name = L"buttonConnectLC";
			this->buttonConnectLC->Size = System::Drawing::Size(211, 23);
			this->buttonConnectLC->TabIndex = 0;
			this->buttonConnectLC->Text = L"Connect to Load Cell";
			this->buttonConnectLC->UseVisualStyleBackColor = true;
			this->buttonConnectLC->Click += gcnew System::EventHandler(this, &Form1::buttonConnectLC_Click);
			// 
			// textBoxAnalogValue
			// 
			this->textBoxAnalogValue->Location = System::Drawing::Point(6, 47);
			this->textBoxAnalogValue->Name = L"textBoxAnalogValue";
			this->textBoxAnalogValue->Size = System::Drawing::Size(209, 20);
			this->textBoxAnalogValue->TabIndex = 1;
			this->textBoxAnalogValue->Text = L"Not Connected";
			// 
			// Form1
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(569, 330);
...
#pragma endregion
	...
	private: System::Void buttonSend_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 //{
				 String^ xyz = this->textBoxStepSize->Text;
				 std::string converted_xyz=msclr::interop::marshal_as< std::string >( xyz);
				 int speed = atoi(converted_xyz.c_str());

				 xyz = this->textBoxNumOfSteps->Text;
				 converted_xyz=msclr::interop::marshal_as< std::string >( xyz);
				 int torque = atoi(converted_xyz.c_str());

				 xyz = this->textBoxDwellTime->Text;
				 converted_xyz=msclr::interop::marshal_as< std::string >( xyz);
				 int position = atoi(converted_xyz.c_str());
...
private: System::Void buttonConnectLC_Click(System::Object^  sender, System::EventArgs^  e) {
